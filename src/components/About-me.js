    ...
    return (
        <Stack id="about-me" direction="column" alignItems="center" justifyContent="center" spacing={5} sx={
            ...
            <Typography variant="body1" sx={{width: ['100%', '75%', '50%']}}>
                ...
                <br /><br />
                Andrzej can be seen in the 2004 top-ranked Japanese movie "Otosan-no Backdrop", the 2009 hit movie "Hagetaka" , as well as in the movie "Miracle City Koza" in 2022.
            </Typography>
        </Stack>
    );
  }